      ...
      <div className="flex flex-col gap-5 px-5 py-5 mb-20 bg-dark-transparent rounded-2xl border border-white/20">
        <Container>
          ...
          <p className="text-gray-300 leading-relaxed mb-5">
            ...
            representing staked <span className="font-bold text-white">stSTT</span>, called{" "}
            <span className="font-bold" style={{ color: "#1BDEBF" }}>
              PT-stSTT
            </span>
            . Since{" "}
          ...
          <p className="text-gray-300 leading-relaxed mb-10">
            ...
            at <span className="font-bold text-white">0.9 STT</span>, once maturity arrives they can
            redeem it for <span className="font-bold text-white">1 STT</span>. The payout at
      ...
      <div className="flex flex-col gap-5 px-5 py-5 mb-20 bg-dark-transparent rounded-2xl border border-white/20">
        <Container>
          ...
          <p className="text-gray-300 leading-relaxed mb-5">
            ...
            <span className="font-bold text-white">stSTT</span> until maturity to be 5%, but{" "}
            <span className="font-bold" style={{ color: "#1BDEBF" }}>
              PT-stSTT
            </span>{" "}
